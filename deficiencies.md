...
- Generic checkout/catalogue/cart labels now use scoped Hungarian localization and the current local BACS/free-shipping setup passed the transaction presentation matrix. Final GLS, Barion, invoicing, and legal-document wording remain separate integration and business-approval work; provider titles are intentionally not hardcoded by the localization layer.
