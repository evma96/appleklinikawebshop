...
try {
    ...
    $test->assert(str_contains($checkoutScript, 'Nincs külön mentett címed.') && str_contains($checkoutScript, 'ak-checkout-address-selector__manual-help'), 'manual entry explains that prefilled checkout fields are not a separate saved address');
