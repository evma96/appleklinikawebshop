...
final class ProductFrontendDisplay
{
    ...
    public function renderStyles(): void
    {
        ...
        echo '<style>
            ...
            .appleklinika-product-gallery--phone-portrait .appleklinika-product-gallery__stage img{width:auto;height:86%;max-width:86%;max-height:92%}
