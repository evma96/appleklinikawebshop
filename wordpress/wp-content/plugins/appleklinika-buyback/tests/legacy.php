...
$test->assert(APPLEKLINIKA_BUYBACK_SCHEMA_VERSION === '1.2.0', 'Code schema is 1.2.0');
$test->assert(get_option(Schema::OPTION_SCHEMA_VERSION) === '1.2.0', 'Installed schema is 1.2.0');
