...
try {
    ...
    $test->assert(APPLEKLINIKA_BUYBACK_SCHEMA_VERSION === '1.0.0', 'Code schema version remains 1.0.0');
    $test->assert($schemaVersionBefore === '1.0.0', 'Installed schema version remains 1.0.0');
