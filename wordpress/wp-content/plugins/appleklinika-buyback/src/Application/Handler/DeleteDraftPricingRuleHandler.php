...
final class DeleteDraftPricingRuleHandler
{
    ...
    public function handle(DeleteDraftPricingRule $command): void
    {
        $this->transactions->transactional(function () use ($command): void {
            ...
            $this->rules->deleteDraftRule($bookId, $ruleId, new AggregateVersion($command->expectedRuleVersion));
