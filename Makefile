...
test: test-unit test-integration test-backoffice-workflow
...
test-backoffice-workflow:
	...
	$(COMPOSE) exec -T wordpress php /var/www/html/wp-content/plugins/appleklinika-backoffice/tests/dedicated-host-urls.php
...
test-cart-checkout:
	$(COMPOSE) exec -T wordpress php /var/www/html/wp-content/themes/appleklinika-theme/tests/cart-checkout.php

test-checkout-stepper: test-cart-checkout

test-checkout-summary: test-cart-checkout

test-order-company-contract:
	$(COMPOSE) exec -T wordpress php /var/www/html/wp-content/themes/appleklinika-theme/tests/cart-checkout-company-contract.php

test-order-finalization:
	$(COMPOSE) exec -T wordpress php /var/www/html/wp-content/themes/appleklinika-theme/tests/cart-checkout-order-finalization.php

test-order-flow:
	$(MAKE) test-order-finalization
...
test-customer-address-book-checkout:
	$(COMPOSE) exec -T wordpress php /var/www/html/wp-content/plugins/appleklinika-customer-address-book/tests/checkout.php
